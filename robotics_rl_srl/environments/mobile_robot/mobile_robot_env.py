...
class MobileRobotGymEnv(SRLGymEnv):
    ...
    def __init__(self, urdf_root=pybullet_data.getDataPath(), renders=False, is_discrete=False,
    ...
    def reset(self):
        ...
        self.target_uid = p.loadURDF("robotics_rl_srl/urdf/cylinder.urdf", [x_pos, y_pos, 0], useFixedBase=True)
        self.target_pos = np.array([x_pos, y_pos, 0])

        # Add walls
        # Path to the urdf file
        wall_urdf = "robotics_rl_srl/urdf/wall.urdf"
        # Rgba colors
