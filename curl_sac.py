...
class CurlSacAgent(object):
    ...
    def update_cpc(self, obs_anchor, obs_pos, cpc_kwargs, L, step):
        ...
        logits = self.CURL.compute_dists(z_a, z_pos)
    ...
    def update(self, replay_buffer, L, step, enc_train=True, sub_goal=False):
        if self.encoder_type == 'pixel':
            obs, action, reward, next_obs, goal_obs, not_done, cpc_kwargs = replay_buffer.sample_cpc()
        else:
